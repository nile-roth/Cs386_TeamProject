...
(5). In addition to the timer on the Money Monkey display, a wage clock will also be shown. This wage clock will increment every second according to the calculated wage per second for the user. **Workers** can <ins>view</ins> the wage clock throughout their **shift** if needed, and watch in real time how their earnings correspond to the amount of time they’ve spent at work without having to do any calculations themselves. 
